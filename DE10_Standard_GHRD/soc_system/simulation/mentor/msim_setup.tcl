...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/tdn/intelFPGA_lite/24.1std/quartus/"
}
...
ensure_lib                                                                    ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_rsp_width_adapter/
vmap       parallel_port_out_axi_avalon_parallel_port_slave_rsp_width_adapter ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_rsp_width_adapter/
...
ensure_lib                                                                    ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter/    
vmap       parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter     ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter/    
...
ensure_lib                                                                    ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_agent_rsp_fifo/   
vmap       parallel_port_out_axi_avalon_parallel_port_slave_agent_rsp_fifo    ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_agent_rsp_fifo/   
ensure_lib                                                                    ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_agent/            
vmap       parallel_port_out_axi_avalon_parallel_port_slave_agent             ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_agent/            
ensure_lib                                                                    ./libraries/hps_0_h2f_axi_master_agent/                                        
vmap       hps_0_h2f_axi_master_agent                                         ./libraries/hps_0_h2f_axi_master_agent/                                        
ensure_lib                                                                    ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_translator/       
vmap       parallel_port_out_axi_avalon_parallel_port_slave_translator        ./libraries/parallel_port_out_axi_avalon_parallel_port_slave_translator/       
...
ensure_lib                                                                    ./libraries/parallel_port_out_axi/                                             
vmap       parallel_port_out_axi                                              ./libraries/parallel_port_out_axi/                                             
ensure_lib                                                                    ./libraries/parallel_port_in_axi/                                              
vmap       parallel_port_in_axi                                               ./libraries/parallel_port_in_axi/                                              
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                           -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_rsp_width_adapter
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                       -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_rsp_width_adapter
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_rsp_width_adapter
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                           -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                                    -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                                      -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                       -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                           -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                           -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                        -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                       -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                       -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                         -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter    
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                                               -work parallel_port_out_axi_avalon_parallel_port_slave_agent_rsp_fifo   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                             -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_agent            
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_agent            
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                        -L altera_common_sv_packages -work parallel_port_out_axi_avalon_parallel_port_slave_translator       
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_parallel_port_out_axi.v"                                                                    -work parallel_port_out_axi                                             
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_parallel_port_in_axi.v"                                                                     -work parallel_port_in_axi                                              
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L border -L avalon_st_adapter -L parallel_port_out_axi_avalon_parallel_port_slave_rsp_width_adapter -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L parallel_port_out_axi_avalon_parallel_port_slave_burst_adapter -L hps_0_h2f_axi_master_wr_limiter -L router_002 -L router -L parallel_port_out_axi_avalon_parallel_port_slave_agent_rsp_fifo -L parallel_port_out_axi_avalon_parallel_port_slave_agent -L hps_0_h2f_axi_master_agent -L parallel_port_out_axi_avalon_parallel_port_slave_translator -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_0 -L parallel_port_out_axi -L parallel_port_in_axi -L hps_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
